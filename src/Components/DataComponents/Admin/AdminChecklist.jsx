...
const AdminChecklist = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-5 gap-3">
        ...
        <div className="flex ">
          <button
            ...
            type="button"
            className="text-white  bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br  focus:outline-none  font-medium rounded-lg text-sm px-5 py-1.5 text-center me-2 mb-2"
          >
            Create
          </button>
          <button
      ...
      <Modal open={showModal} onClose={handleCloseModal} className="" size="lg">
            ...
            <div className=" w-[300px] md:w-[500px] lg:w-[700px] border-b border-solid border-blueGray-200 p-3 flex-auto max-h-[400px] overflow-y-auto gap-6">
              <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    onChange={(e) =>
                      handleFormData("checklisttype", e.target.value)
                    }
                    type="text"
                ...
                <div class="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    onChange={(e) =>
                      handleFormData("checkpointtype", e.target.value)
                    }
                    type="text"
                ...
                <div class="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    onChange={(e) =>
                      handleFormData("checkpoint", e.target.value)
                    }
                    type="text"
                    value={currentData?.checkpoint}
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder=" "
                    required
                  />
                ...
                <div class="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    onChange={(e) => handleFormData("result", e.target.value)}
                    type="text"
                ...
                <div class="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    onChange={(e) =>
                      handleFormData("resulttype", e.target.value)
                    }
                    type="text"
                    value={currentData?.resulttype}
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder=" "
                    required
                  />
