         ...
         <ModalDialog size='lg' className="p-2 " >
           ...
           <form onSubmit={(e) => {
             ...
             <div className=" w-[300px] md:w-[500px] lg:w-[700px] border-b border-solid border-blueGray-200 p-3 flex-auto max-h-[400px] overflow-y-auto">
               ...
               <div class="grid md:grid-cols-2 md:gap-6">
                 ...
                 <div className='relative z-0 w-full mb-5 group'>
                   ...
                   <input type="text" onChange={(e) => handleFormData('name', e.target.value)} name="name" id="name" value={currentCountry?.name} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
 
                 </div>
                 <div>
                   <label class="block mb-2 text-sm font-medium text-gray-900 ">Status</label>
 
                    <Select variant='soft' className='rounded-[4px] py-2 border' defaultValue={currentCountry?.status || ""} onChange={(e, value) => handleFormData('status', value)}>
             ...
             <div className="flex items-center justify-end mt-3 rounded-b">
               ...
               <button onClick={() => handleSubmit(currentCountry?._id)} type="submit" className="text-white bg-blue-700 h-8 hover:bg-blue-800 focus:ring-4  flex items-center px-8 focus:ring-blue-300 font-medium rounded-[4px] text-sm  py-2.5 me-2 mb-2 :bg-blue-600 :hover:bg-blue-700 focus:outline-none :focus:ring-blue-800 me-2 mb-2">Save Country</button>
             </div>
           </form>
