...
const AdminRoles = () => {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`${process.env.REACT_APP_BASE_URL}/collections/role/${id}`)
          .then((res) => {
            Swal.fire(
              "Deleted!",
  ...
  const getAllData = () => {
    axios.get(`${process.env.REACT_APP_BASE_URL}/collections/role?page=${page}&limit=${limit}`)
      .then((res) => {
  ...
  const handleAddData = () => {
    axios.post(`${process.env.REACT_APP_BASE_URL}/collections/role`, currentData)
      .then((res) => {
        getAllData()
      }).catch((error) => { console.log(error) })
  }
  ...
  const handleEditData = (id) => {
    axios.patch(`${process.env.REACT_APP_BASE_URL}/collections/role/${id}`, currentData)
      .then((res) => {
        getAllData()
      }).catch((error) => { console.log(error) })
  }
