...
function Aerb() {
    ...
    const handleDelete = (id) => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.delete(`${process.env.REACT_APP_BASE_URL}/collections/aerb/${id}`)
            .then((res) => {
              Swal.fire(
                "Deleted!",
    ...
    const getData = () => {
      setLoader(true)
      axios.get(`${process.env.REACT_APP_BASE_URL}/collections/aerb?page=${page}&limit=${limit}`)
        .then((res) => {
          setLoader(false)
    ...
    const handleCreate = () => {
      axios.post(`${process.env.REACT_APP_BASE_URL}/collections/aerb`, currentData)
        .then((res) => {
          getData()
        }).catch((error) => { console.log(error) })
    }
    ...
    const handleEditCountry = (id) => {
      axios.put(`${process.env.REACT_APP_BASE_URL}/collections/aerb/${id}`, currentData)
        .then((res) => {
          getData()
        }).catch((error) => { console.log(error) })
    }
