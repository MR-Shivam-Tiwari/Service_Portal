...
function Customer() {
  ...
  return (
    ...
    >
      ...
      <button onClick={hanleCloseModal} type="button" className="text-white col-span-2 md:col-span-1 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br  focus:outline-none  font-medium rounded-lg text-sm px-5 py-1.5 text-center me-2 mb-2">Create</button>
      ...
      <ModalDialog size='lg' className="p-2 " >
        ...
        <form onSubmit={(e) => {
          ...
          <div className="flex items-center justify-end mt-3 rounded-b">
            ...
            <button onClick={() => hanleCloseModal()} type="button" class="focus:outline-none text-black  focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 :bg-red-600 :hover:bg-red-700 :focus:ring-red-900 me-2 mb-2">Close</button>
