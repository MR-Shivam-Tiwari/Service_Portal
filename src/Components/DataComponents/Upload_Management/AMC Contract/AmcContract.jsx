      ...
      <table className="w-full  border  min-w-max caption-bottom text-sm">
        <thead className="[&amp;_tr]:border-b bg-blue-700 ">
          <tr className="border-b transition-colors  text-white hover:bg-muted/50 data-[state=selected]:bg-muted">
            ...
            <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Sa type</th>
        ...
        <tbody className="[&amp;_tr:last-child]:border-0  ">
          {data?.map((item, index) => (
            <tr key={item?._id} className="border-b transition-colors  data-[state=selected]:bg-muted">
              ...
              <td className="p-4 font- text-md capitalize align-middle whitespace-nowrap">{item?.salesdoc}</td>
              <td className="p-4 font- text-md capitalize align-middle whitespace-nowrap">{moment(item?.startdate).format("MMM D, YYYY")}</td>
              <td className="p-4 font- text-md capitalize align-middle whitespace-nowrap">{moment(item?.enddate).format("MMM D, YYYY")}</td>
              <td className="p-4 font- text-md capitalize align-middle whitespace-nowrap">{item?.satypeZDRC_ZDRN}</td>
          ...
          <div className=" w-[300px] md:w-[500px] lg:w-[700px] border-b border-solid border-blueGray-200 p-3 flex-auto max-h-[400px] overflow-y-auto">
            ...
            <div class="grid md:grid-cols-2 md:gap-6 w-full">
              ...
              <div className='relative  w-full mb-5 group'>
                <label class="block mb-2 text-sm font-medium text-gray-900 ">Sales Doc</label>
                <input type="text" required  onChange={(e) => handleFormData('salesdoc', e.target.value)} id="name" value={currentData?.salesdoc} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />

              </div><div className='relative  w-full mb-5 group'>
                <label class="block mb-2 text-sm font-medium text-gray-900 ">Start Date		</label>
                <input type="date" onChange={(e) => handleFormData('startdate', e.target.value)} id="name" value={currentData?.startdate?.split('T')[0]} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />

              </div><div className='relative  w-full mb-5 group'>
                <label class="block mb-2 text-sm font-medium text-gray-900 ">End Date		</label>
                <input type="date" onChange={(e) => handleFormData('enddate', e.target.value)} id="name" value={currentData?.enddate?.split('T')[0]} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />

              </div>
              <div className='relative  w-full mb-5 group'>
                <label class="block mb-2 text-sm font-medium text-gray-900 ">Sa type	</label>
                <input type="text" onChange={(e) => handleFormData('satypeZDRC_ZDRN', e.target.value)} id="name" value={currentData?.satypeZDRC_ZDRN} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
